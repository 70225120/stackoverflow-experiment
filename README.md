...
Выбран датасет Stack Overflow Questions 2020-2025 - источник [kaggle](https://www.kaggle.com/datasets/kutayahin/stackoverflow-programming-questions-2020-2025/data). В датасете представлена выборка 95,636 вопросов с портала StackOverflow за 2021-2025 годы. 
